...
*/
int8_t SX1278::setChannel(uint64_t frequency)
{
  byte st0;
  int8_t state = 2;
  unsigned int freq3;
  ...
  freq3 = ((frf >> 16) & 0x0FF);		// frequency channel MSB
  freq2 = ((frf >> 8) & 0x0FF);		// frequency channel MIB
  freq1 = (frf & 0xFF);				// frequency channel LSB
